defmodule Ace.HTTP2.Frame.Priority do
  ...
  defimpl Inspect, for: Ace.HTTP2.Frame.Priority do
    def inspect(%{stream_id: stream_id, stream_dependency: stream_dependency, weight: weight, exclusive: exclusive}, _opts) do
      "PRIORITY(stream_id: #{stream_id}, stream_dependency: #{stream_dependency}, weight: #{weight}, exclusive: #{exclusive})"
    end
  end
end
