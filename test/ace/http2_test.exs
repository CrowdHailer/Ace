defmodule Ace.HTTP2Test do
  ...
  # connection test pre HTTP2 check alpn etc

  # 1. setup test
  #   client missing preface
  #   client not sending settings
  #   settings frame on invalid channel
  #   settings frame that is an ack

  # 2. channel/request test
  # start with header
